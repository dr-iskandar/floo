...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HorizontalScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
		...
		[Tooltip("The distance between two pages, by default 3 times the height of the control -- modif to (*1)+50")]
        ...
        void Start()
        {
            ...
            if (PageStep == 0)
            {
                PageStep = (int)(_scroll_rect.GetComponent<RectTransform>().rect.width * 1)+ 25;
            }
            DistributePages();
